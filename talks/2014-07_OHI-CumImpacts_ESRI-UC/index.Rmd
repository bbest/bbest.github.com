...
- Download Python Toolbox at [github.com/ohi-science/cumimpacts](http://github.com/ohi-science/cumimpacts)
    ...
    - Soon linked from [nceas.ucsb.edu/globalmarine](http://www.nceas.ucsb.edu/globalmarine), [ohi-science.org](http://ohi-science.org)

- Update with matrix math for speed up: 2 hours to 2 minutes (Dan Yocum)
...
suppressPackageStartupMessages({
  library(shiny)
  library(devtools); load_all('~/github/ohicore', quiet=T)
  #library(ohicore)
  })
...
> - [http://bbest.github.io/talks/2014-07_ohi-cumimpacts_esri-uc](bbest.github.io/talks/2014-07_ohi-cumimpacts_esri-uc)
